...
const props = defineProps(["product", "active"]);

const product_total = computed(() => {
  return cartStore.productQuantity(props.product);
});

const addToCart = () => {
  return cartStore.addToCart(props.product);
};

const removeFromCart = () => {
  return cartStore.removeFromCart(props.product);
};
</script>
